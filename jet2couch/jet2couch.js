...
if (args.length < 3) {
  console.log('Usage:')
  console.log('  jet2couch [MSAccess file-path] [tables...] [couch]')
  console.log('')
  console.log('Example:')
  console.log('  jet2couch forests.mdb Forests Trees http://<username>:<password>@yourcouch.com/dbname')
  return;
}
...
function init() {
  ...
  var csvArgs = [__dirname + '/jet2csv.js', mdb, csvsFolder]
